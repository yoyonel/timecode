...
class PyTimeCodeTester(unittest.TestCase):
    """tests PyTimeCode class
    """
    ...
    def test_instance_creation(self):
        ...
        """
        PyTimeCode('23.98', '00:00:00:00')
        PyTimeCode('24', '00:00:00:00')
        PyTimeCode('25', '00:00:00:00')
        PyTimeCode('29.97', '00:00:00:00')
        PyTimeCode('30', '00:00:00:00')
        PyTimeCode('50', '00:00:00:00')
        PyTimeCode('59.94', '00:00:00:00')
        PyTimeCode('60', '00:00:00:00')
    ...
    def test_op_overloads_add(self):
        tc = PyTimeCode('29.97', '03:36:09:23')
        tc2 = PyTimeCode('29.97', '00:00:29:23')
        d = tc + tc2
        f = tc + 894
        ...
        tc = PyTimeCode('59.94', '03:36:09:23')
        tc2 = PyTimeCode('59.94', '00:00:29:23')
        ...
        tc = PyTimeCode('23.98', '03:36:09:23')
        tc2 = PyTimeCode('23.98', '00:00:29:23')
        ...
        tc = PyTimeCode('ms', '03:36:09:230')
        tc2 = PyTimeCode('ms', '01:06:09:230')
    ...
    def test_op_overloads_mult(self):
        tc = PyTimeCode('29.97', '00:00:09:23')
        tc2 = PyTimeCode('29.97', '00:00:29:23')
        d = tc * tc2
        f = tc * 4
    ...
    def test_24_hour_limit_in_24fps(self):
        ...
        in 24 fps
        """
        tc = PyTimeCode('24', '00:00:00:21')
        tc2 = PyTimeCode('24', '23:59:59:23')
        self.assertEqual(
            '00:00:00:21',
            (tc + tc2).__str__()
        )
    ...
    def test_24_hour_limit_in_2997fps(self):
        ...
        tc2 = PyTimeCode('29.97', '23:59:59:29')
    ...
    def test_24_hour_limit(self):
        ...
        in 29.97 fps
        """
        tc0 = PyTimeCode('59.94', '23:59:59:29')
        self.assertEqual(5178786, tc0.frames)
        tc0 = PyTimeCode('29.97', '23:59:59:29')
        self.assertEqual(2589408, tc0.frames)

        tc1 = PyTimeCode('29.97', frames=2589408)
        ...
        tc = PyTimeCode('29.97', '04:20:13:21')
        tca = PyTimeCode('29.97', frames=467944)
        ...
        tc2a = PyTimeCode('29.97', frames=2589408)
        ...
        tc = PyTimeCode('59.94', '04:20:13:21')
        self.assertEqual('04:20:13:21', tc.__str__())

        tca = PyTimeCode('59.94', frames=935866)
        self.assertEqual('04:20:13:21', tc.__str__())

        tc2 = PyTimeCode('59.94', '23:59:59:59')
        tc3 = (tc + tc2)
        self.assertEqual('04:20:13:21', tc3.__str__())
    ...
    def test_exceptions(self):
        """test exceptions
        """
        # with self.assertRaises(PyTimeCodeError) as cm:
        #     PyTimeCode('23.98', '01:20:30:303')
